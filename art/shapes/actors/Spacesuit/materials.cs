...
new Material(PlayerLightBody)
{
   ...
   diffuseMap[0] = "player_light_body_diffuse";
   normalMap[0] = "player_light_body_bump";
...
new Material(PlayerLightArmor)
{
   ...
   diffuseMap[0] = "player_light_armor_diffuse";
   pixelSpecular[0] = true;
   specular[0] = "1 1 1 1";
...
new Material(PlayerLightHead)
{
   ...
   diffuseMap[0] = "player_light_head_diffuse";
   normalMap[0] = "player_light_head_bump";
   pixelSpecular[0] = true;
   specular[0] = "0.5 0.5 0.5 0.8";
   specularPower[0] = 32.0;
   AllowExposure[0] = false;
...
new Material(PlayerLightGlass)
{
   ...
   diffuseMap[0] = "player_light_glass_diffuse";
   pixelSpecular[0] = true;
