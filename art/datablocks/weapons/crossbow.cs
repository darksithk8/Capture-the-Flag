...
datablock ParticleData(CrossbowSplashMist)
{
   ...
   spinRandomMin        = -90.0;
   spinRandomMax        = 500.0;
   textureName          = "art/shapes/particles/splash";
...
datablock ParticleData(CrossbowBoltParticle)
{
   ...
   inheritedVelFactor   = 0.0;
   lifetimeMS           = 75;
   lifetimeVarianceMS   = 5;   // ...more or less
   useInvAlpha = false;
   spinRandomMin = -30.0;
   spinRandomMax = 30.0;
...
{
   shapeFile = "art/shapes/weapons/crossbow/debris.dts";
...
{
   projectileShapeName = "art/shapes/weapons/crossbow/projectile.dts";
   directDamage        = 20;
   radiusDamage        = 20;
   damageRadius        = 1.5;
   areaImpulse         = 2000;
...
datablock ItemData(Crossbow)
{
   ...
   emap = true;
	...
	// weaponHUD
   previewImage = 'crossbowpicture2.png';
   reticle = 'reticle_crossbowpicture';
};
...
function CrossbowImage::onFire(%this, %obj, %slot)
{
   ...
   CommandToClient(%obj.client, 'SetAmmo', %obj.getInventory(%obj.getMountedImage(0).Ammo));
