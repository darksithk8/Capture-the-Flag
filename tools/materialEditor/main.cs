...
function MaterialEditorPlugin::onWorldEditorStartup( %this )
{
   ...
   AttachWindows( MaterialEditorPropertiesWindow, MaterialEditorPreviewWindow);
   ...
   %map.bindCmd( keyboard, "z", "commandToServer('SetEditorCameraStandard');", "" );// Free Camera
   %map.bindCmd( keyboard, "e", "MatEd_editMaterial.performClick();", "" );// Material Selector
