...
new SimGroup (ShapeHintGroup)
{
   new ScriptObject()
   {
      ...
      node2 = "mount0-31" TAB "Nodes used for mounting ShapeBaseImages to this object";
      node3 = "AIRepairNode" TAB "unused";
   ...
   new ScriptObject()
   {
      ...
      sequence9 = "side" TAB "Player is running sideways (strafing)";
