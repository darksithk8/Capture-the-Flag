...
EditorSettings.setDefaultValue(  "documentationURL",        "http://docs.garagegames.com/t3d/official/"           );
EditorSettings.setDefaultValue(  "forumURL",                "http://www.garagegames.com/community/forums/63"      );
EditorSettings.endGroup();
...
EditorSettings.setDefaultValue(  "maxBrushSize",            "48 48"           );
...
setDefault( "$pref::WorldEditor::currentEditor", "WorldEditorInspectorPlugin" );
...
function EditorGui::readTerrainEditorSettings(%this)
{
   ...
   ETerrainEditor.currentAction           = EditorSettings.value("currentAction");
...
function EditorGui::writeTerrainEditorSettings(%this)
{
   ...
   EditorSettings.setValue( "currentAction",          ETerrainEditor.currentAction );
