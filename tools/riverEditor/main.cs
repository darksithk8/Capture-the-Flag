...
function initializeRiverEditor()
{
   ...
   %map.bindCmd( keyboard, "delete", "RiverEditorGui.deleteNode();", "" ); 
   ...
   %map.bindCmd( keyboard, "c", "RiverEditorShowRoadBtn.performClick();", "" );   
...
{    
   ...
   AttachWindows( RiverEditorOptionsWindow, RiverEditorTreeWindow);
